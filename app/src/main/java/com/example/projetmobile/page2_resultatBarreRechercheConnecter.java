...
public class page2_resultatBarreRechercheConnecter extends AppCompatActivity {
    ...
    Intent IntentRetour;
    Intent IntentPagePrincipaleDeconnecter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IntentRetour=new Intent(page2_resultatBarreRechercheConnecter.this, MainActivityConnecter.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.deconnexion:
                startActivity(IntentPagePrincipaleDeconnecter);
                return (true);
        }
        return true;
    }
        ...
        protected void onPostExecute(ArrayList<Movie> result) {
            if (result.size()>1){
                ...
                recycler.setLayoutManager(new
                        LinearLayoutManager(page2_resultatBarreRechercheConnecter.this));
